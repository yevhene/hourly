...
# Hourly.Web.Endpoint.load_from_system_env/1 dynamically.
...
config :hourly, Hourly.Web.Endpoint,
  on_init: {Hourly.Web.Endpoint, :load_from_system_env, []},
  url: [scheme: "https", host: "api-hourly.herokuapp.com", port: 443],
